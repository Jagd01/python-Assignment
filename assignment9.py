...
print("So the total number of person is",n)
choice=input("yes,No")
choice=choice.strip()
if choice.lower()=="yes" or choice.lower()=="y":
    ...
    if n3>=65:
        ...
        print("you are a adult  so you get 0% discount")
        price2=price
        print("After discount the price is",price2)
    else:
        print("invalid entry")
    ...
    print("you cannot go with out ticket it is illegal")
else:
    print("Invalid entry")
    print("wish you a Good Journey")
